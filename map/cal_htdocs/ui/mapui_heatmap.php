...
//	g_imgarray[g_nUsedImages].alt = name;
	...
	g_imgarray[g_nUsedImages].src = 'icons/../../usericons/abarry.gif';
	if (boolFind == false)
	{
...
function createHeatMap()
{
	...
	drawIcon( aPeopleData[0], aPeopleData[1], titleString, placeString, timeAgoString, fadedIcon, map, aPeopleData[5], icon, false);
}
