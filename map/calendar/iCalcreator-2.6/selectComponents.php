...
$pstartYYYYMMDD = ( isset( $_REQUEST['pstart'] )) ? $_REQUEST['pstart'] : '19970301';
$pendYYYYMMDD   = ( isset( $_REQUEST['pend'] ))   ? $_REQUEST['pend']   : '19980228';
...
if( isset( $_REQUEST['f'] )) {
  ...
  dispHeader( '' );
  echo "<h2>$filename</h2>\n";
  if( FALSE === $c->parse( $filename ))  // filename for file to parse !!!
    echo "FALSE from parse function<br />\n"; // test ###
//  echo "dir =".$c->directory."<br />\n"; // test ###
//  echo "file=".$c->filename."<br />\n"; // test ###
}
else {
$header = array( '41 Recurrence examples from rfc2445, 4.8.5.4 Recurrence Rule'
               ...
               , 'Displays date and all properties for recurring events 1997-03 - 1998-02' );
dispHeader( $header );
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970902T090000' );
  $o->setProperty( 'comment', 'RRULE:FREQ=DAILY;COUNT=10' );
  $o->setProperty( 'comment', '==> (1997 9:00 AM EDT)September 2-11' );
  $o->setProperty( 'dtstart', '19970902T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "DAILY"
                      , 'COUNT'      => 10));
  $c->setComponent( $o );
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19980101T090000' );
  ...
  $o->setProperty( 'dtstart', '19980101T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970905T090000' );
  ...
  $o->setProperty( 'dtstart', '19970905T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970907T090000' );
  ...
  $o->setProperty( 'dtstart', '19970907T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'INTERVAL'   => 2
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970922T090000' );
  ...
  $o->setProperty( 'dtstart', '19970922T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'COUNT'      => 6
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970928T090000' );
  ...
  $o->setProperty( 'comment', '    ...' );
  $o->setProperty( 'dtstart', '19970928T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'BYMONTHDAY' => -3 ));
  $c->setComponent( $o );
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970930T090000' );
  ...
  $o->setProperty( 'dtstart', '19970930T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970910T090000' );
  ...
  $o->setProperty( 'dtstart', '19970910T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'INTERVAL'   => 18
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970610T090000' );
  ...
  $o->setProperty( 'dtstart', '19970610T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'COUNT'      => 10
                      , 'BYMONTH'    => array( 6, 7 )));
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970310T090000' );
  ...
  $o->setProperty( 'dtstart', '19970310T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'INTERVAL'   => 2
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970101T090000' );
  ...
  $o->setProperty( 'dtstart', '19970101T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'INTERVAL'   => 3
                      , 'COUNT'      => 10
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970519T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970519T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970512T090000' );
  ...
  $o->setProperty( 'comment', '    (1999 9:00 AM EDT)May 17' );
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970512T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'BYWEEKNO'   => 20
                      , 'BYDAY'      => array( 'DAY' => 'MO' )));
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970313T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970313T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'BYMONTH'    => 3
                      , 'BYDAY'      => array( 'DAY' => 'TH' )));
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970605T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970605T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'BYMONTH'    => array( 6, 7, 8 )
                      , 'BYDAY'      => array( 'DAY' => 'TH' )));
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970902T090000' );
  $o->setProperty( 'comment', 'EXDATE;TZID=US-Eastern:19970902T090000' );
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970913T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970913T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'BYDAY'      => array( 'DAY' => 'SA' )
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19961105T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19961105T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "YEARLY"
                      , 'INTERVAL'   => 4
                      , 'BYMONTH'    => 11
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970904T090000' );
  ...
  $o->setProperty( 'dtstart', '19970904T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'COUNT'      => 3
                      , 'BYDAY'      => array( array( 'DAY' => 'TU' )
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970929T090000' );
  ...
  $o->setProperty( 'comment', '     ...' );
  $o->setProperty( 'dtstart', '19970929T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "MONTHLY"
                      , 'BYDAY'      => array( array( 'DAY' => 'MO' )
                                              ,array( 'DAY' => 'TU' )
...
/* start *//**/
  ...
  $o->setProperty( 'comment', 'DTSTART;TZID=US-Eastern:19970805T090000' );
  ...
  $o->setProperty( 'dtstart', '19970805T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "WEEKLY"
                      , 'INTERVAL'   => 2
                      , 'COUNT'      => 4
...
/* start *//**/
  ...
  $o->setProperty( 'dtstart', '19970805T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'dtend',   '19970806T090000', array('TZID' => 'US-Eastern'));
  $o->setProperty( 'rrule'
               , array( 'FREQ'       => "WEEKLY"
                      , 'INTERVAL'   => 2
                      , 'COUNT'      => 4
...
$c->sort();
$sc = $c->selectComponents( $pstartY, $pstartM, $pstartD, $pendY, $pendM, $pendD );
// $sc = $c->selectComponents( $pstartY, $pstartM, $pstartD, $pendY, $pendM, $pendD, FALSE, FALSE, TRUE, FALSE );
if( $sort )
  selsortshow( $sc);
else
  selshow( $sc);
